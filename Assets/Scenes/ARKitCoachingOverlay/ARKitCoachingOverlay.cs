...
public class ARKitCoachingOverlay : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="animated">If <c>true</c>, the coaching overlay is animated, e.g. fades out. If <c>false</c>, the coaching overlay disapears instantly, without any transition.</param>
