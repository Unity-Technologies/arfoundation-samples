Shader "Unlit/Confidence"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fragment_output frag (v2f i)
            {
                ...
                // Sample the confidence (from 0.0 to 1.0).
                float confidence = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.texcoord).r;
                real3 color = real3(confidence, confidence, confidence);

                fragment_output o;
                o.color = real4(color, 1.0h);
                return o;
            }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define DECLARE_TEXTURE2D(texture) UNITY_DECLARE_TEX2D(texture)
            #define DECLARE_SAMPLER(sampler)
            ...
            DECLARE_TEXTURE2D(_MainTex);
            DECLARE_SAMPLER(sampler_MainTex);
